...
class plgsystemStipadminblockInstallerScript {
	 ...
	 public function postflight($parent) {
		 ...
		 $htaccess[] = 'ErrorDocument 403 "<H1>Je bent geblokkeerd door de firewall</H1><p><strong>Oplossing: </strong>Ga naar je website en typ je-eigen-domeinnaam.nl/beheer ipv je-eigen-domeinnaam.nl/administrator om deze blokkade op te heffen.</p>"';
