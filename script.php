...
class plgsystemStipadminblockInstallerScript {
	 ...
	 public function postflight($parent) {
		 ...
		 $htaccess[] = 'ErrorDocument 403 "<H1 style='text-align:center; margin-top:50px;'>Je bent geblokkeerd door de firewall</H1><p style='text-align:center'>Ga naar de /beheer ipv /administrator om deze blokkade op te heffen.</p>"';
